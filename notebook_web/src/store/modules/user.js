...
const state = {
  ...
  images: [
    require('@/assets/sidebar-img/sidebar-1.jpg'),
    require('@/assets/sidebar-img/sidebar-2.jpg'),
    require('@/assets/sidebar-img/sidebar-3.jpg'),
    require('@/assets/sidebar-img/sidebar-4.jpg'),
  ],
  notifications: [],
  rtl: false,
}
